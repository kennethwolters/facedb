...
Dependencies are:
- [ageitgey/face_recognition](https://github.com/ageitgey/face_recognition) (which dependes heavily on [dlib](https://github.com/davisking/dlib)) to provide a Convolutional Neural Network to get facial encodings (128-dimensional vectors) from images
